# Appium Test Project with Android and iOS

This project is used to automation test using Appium (Android and iOS) with Java.
...
5. Configure the enviroments variable JAVA_HOME, ANDROID_HOME and PATH
